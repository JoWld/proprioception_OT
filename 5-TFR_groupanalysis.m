...
% define OT and HC groups, 2 = foot (but subs and subs2 are identical in final analysis)
...
for ii = 1:length(OT_subs)
    ...
    timelocked = ft_combineplanar([],timelocked);
    [channam_OT2{ii},~,~] = find_ERF_peak(timelocked,time);
